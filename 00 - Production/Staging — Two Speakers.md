...
- **Lip-sync & the uncanny.** Lean into it where useful — the machine *should* be a little uncanny, and so should a news anchor. Minimise it where a video character needs to be believed as decent (Kristina at calibration, HR protecting him procedurally).
