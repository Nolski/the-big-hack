...
- **Beats:** B2 (opener — celebrates the portal, thanks the weekend grind, owns the API-key call, left speechless); B5 (the win becomes the mandate — [[08 - The Win We Needed]]); B7 (the review — [[11 - The Performance Review]]); B8 (offboarding).
...
- **Beats:** B5 — the win becomes the mandate ([[08 - The Win We Needed]]).
