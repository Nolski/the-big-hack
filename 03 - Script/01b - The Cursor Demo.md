...
## Notes
> [!important] Cut pass — this scene now carries [[01d - The Future]]; [[01c - The PR Review]] comes **before** it
> The demo (01b) and the method (01d) were one conversation split across two calls; they are now one call. Everything below "I get why you said this is fun" is 01d's back half, moved verbatim. 01c was cut in a first pass and then restored, because it is the only scene where Brendan tries to show Liam the method and fails; it now sits before this scene, so "Did you show Liam this? / I tried" pays off what the house just watched. **Gone:** the live permissions error and paste-back, the "how much time is it really saving" challenge, the "things it gets wrong" doc (it only paid off in 11c), "you sound like Marcus," Brendan's scaling caution, and the "he felt bad" opener. **Lines changed rather than moved, for review:** (1) Kristina's "marking its own homework" line lost its "I dismissed it in the moment because I was upset" clause; (2) "Did you show Liam this?" lost the "Marcus is a character" half; (3) her closing line lost "Sure. We'll figure that out when we're all shipping ten times faster," which answered the cut caution; (4) the Setting line now says the scene follows Liam's call rather than the cold open. Nothing else was reworded.
...
- **Hand-off:** ends on Brendan alone, her tile still glowing — next morning is [[06 - Good Instinct]].
