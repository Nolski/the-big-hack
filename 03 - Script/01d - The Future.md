...
live_cast: ""
ai_video_assets: "[[AI Video Production Tracker|AIV-010 Kristina — Standup]], [[AI Video Production Tracker|AIV-012 Brendan — Standup]], [[AI Video Production Tracker|AIV-017 Plan + transcript — on-screen UI]], [[AI Video Production Tracker|AIV-018 CI / canary dashboard]]"
tags:
  - scene
  - liam-arc
---
...
- **[[AI Video Production Tracker|AIV-012]] — Brendan:** finally gets to teach the method to someone who lets him; generous about Liam to the end ("he'd be incredible at this"); the one who voices the caution nobody wants to hear.
...
> [!screen] VIDEO — BRENDAN · `AIV-012` *(a tired half-smile)*
> Ha — good. Listen, quick thing. About this morning. *(beat)* I talked to Liam after. For what it's worth — he actually felt bad. About the degree line. Brought it up himself, first thing, unprompted. Said he shouldn't have said it like that.
...
> Yeah, it surprised me too. He's not *trying* to be a monster. He's just really bad at the part where other people are in the room.
...
> [!screen] VIDEO — BRENDAN · `AIV-012` *(lighting up — this is the thing he's been dying to explain)*
> Okay — so that is *exactly* the part I want to show you, because it's the most important bit and he's half right. You *can't* let it grade its own homework. But that's not how you're meant to do it. Can I show you how I actually review this stuff? Two minutes.
...
> [!screen] VIDEO — BRENDAN · `AIV-012`
> That's the whole job now. You've got it in one.
...
> [!screen] VIDEO — BRENDAN · `AIV-012` *(warm)*
> …Yeah. Kind of. Yeah.
...
> [!screen] VIDEO — BRENDAN · `AIV-012` *(a beat — the air changes)*
> …I tried. *(beat)* I, uh — I couldn't really get it in front of him. *(carefully)* I think I just need to spend a bit more time with him. One on one. Get him to actually sit with it.
...
> [!screen] VIDEO — BRENDAN · `AIV-012` *(not wanting to bury him)*
> …He'll come around. He's the smartest person on the team, Kristina, genuinely. He'd be incredible at this.
...
> [!screen] VIDEO — BRENDAN · `AIV-012` *(a small, honest hedge — the one nobody wants)*
