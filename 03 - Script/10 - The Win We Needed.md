...
- **[[AI Video Production Tracker|AIV-095]] — KARA (the reduction):** Head of Product, first seen here now that [[08 - The One-on-One]] is cut; dry, pragmatic, solving the problem she's handed. **She is not the villain and is not wrong on her own terms** — the manager-led downside she names is real and the consistency argument is real. Reuses the locked Kara voice/vector from `AIV-047`. The instrument she proposes is the reduction sheet the audience later reads.

---

## Script

*(THE CEO's office on the screen — glass, a city behind him. KRISTINA across from him, laptop open. Below, LIAM live at his desk, an agent session running, hearing none of this.)*

> [!screen] VIDEO — THE CEO · `AIV-091` *(up, glad)*
> There she is. Sit. I saw the numbers this morning — tell me I'm reading them right.
...
> [!screen] VIDEO — KRISTINA · `AIV-090`
> One engineer, one weekend. He built the whole API with the claude. A quarter ago that's a team and a month.

> [!screen] VIDEO — THE CEO · `AIV-091` *(this is what he's been waiting to ask)*
> That. That's the thing. So where are we on it across the board — is everyone working like that? Because if every engineer we've got is a month faster—

> [!screen] VIDEO — KRISTINA · `AIV-090` *(the hedge)*
> So… it's a mixed picture. Honestly.

> [!screen] VIDEO — THE CEO · `AIV-091`
> Mixed how.

> [!screen] VIDEO — KRISTINA · `AIV-090`
> The newer folks have leaned all the way in — it's changed how fast they move. Some of the senior people are more cautious. And I want to be fair to them, because they're not wrong about everything. Their worry is what's *under* the speed — you ship an API in a weekend, but did anyone really read it? The portal's using long-lived keys; there's a real security argument there. Code that's "done" that nobody fully understands. Juniors not learning the basics because the agent does it for them. The people raising it are some of our best. It isn't foot-dragging. They mean it.

> [!screen] VIDEO — THE CEO · `AIV-091` *(and he does get it — that's what makes it hard)*
> No, I hear that. I don't want a company that ships garbage quickly. *(a beat; the pressure surfaces)* But Kristina — I'm looking at the same dashboard the board is. We've got five quarters of runway if nothing changes. The thing that changed this week is *this*. It's the first real sign we can do more with what we already have. I can't walk back in there and say "some of the senior engineers have reservations."
...
- **Jira, not Linear — the whole engine, and the audience already knows.** Kara picks Jira because that's where the "clean data" is, and that one word is what makes the reduction sheet unable to see Brendan (on Linear) and unable to see Liam's reviews (in no ticketing tool at all). **Her line — *"everyone's work is in Jira"* — is simply false, and no one in the room corrects her, because no one in the room knows.** The audience does: Brendan said so in [[01b - The Cursor Demo]] and Kristina said *"as long as it's tracked somewhere."* **Do not have Kara hedge it, and do not have anyone ask.** She is stating what she believes and she has no reason to check. It detonates silently in the `AIV-076` prologue, in [[14b - Three Weeks]] and again in [[19 - Nine Tickets]]. See [[Rework — Brendan Goes Dark]] §B.
- **Timeline.** The coda is a **clear time jump** (weeks on, a later quarter), not the same afternoon — the reduction is a Q3 event and the mandate is earlier. Establishing the method early and paying it off in Scene 14 turns the prologue sheet from a reveal into dramatic irony (we watched them choose the blunt instrument; now we watch it cut). **If the show ever has to lose time here, the coda can move to its own slot — it is written to survive being lifted out.**
