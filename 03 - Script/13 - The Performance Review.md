...
live_cast: Liam
ai_video_assets: "[[AI Video Production Tracker|AIV-070 Kristina — the review]], [[AI Video Production Tracker|AIV-071 Performance summary — screen]]"
tags:
  - scene
  - liam-arc
---
...
- **Where her numbers come from — and why one of them is wrong.** [[12 - Below Expectations]] now stages the machinery behind this meeting. The nine days and the four lines are exact: someone pulled his review queue at calibration. "Three people came to me, and the word they used was 'friction'" is **knowingly inexact, and stays as written.** Nobody came to her. Three colleagues filled in an anonymous peer form, and the tool generated the word in a summary line she couldn't break out by name even when she asked. She rounds it into something human because that's how she experienced it, and because "a model summarised your peers" is not a sentence you can say to a person you're managing out. Play the line with total sincerity; the audience who watched Scene 12 supplies the gap.
- **"Collaboration: Below Expectations" is a quotation.** The string on `AIV-071` is the cell typed into the calibration sheet in Scene 12 (`AIV-066`). Keep them identical.
- **Her advocacy is now on stage.** "I pushed back on this… I've been in your corner all year" is verifiable — the audience watched her make the Saturday-that-never-happened argument and lose it to a distribution due Thursday. They also watched her trade Liam's Exceeds slot to Brendan in the same call, which she does not mention here and never will.
