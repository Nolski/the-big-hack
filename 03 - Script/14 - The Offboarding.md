...
world: modern
arc: liam-arc
beat: "[[Liam Arc]] — the reduction"
status: drafted
runtime_estimate: ~6 min
live_cast: Liam
ai_video_assets: "[[AI Video Production Tracker|AIV-076 The reduction — screen]], [[AI Video Production Tracker|AIV-073 The improvement plan — screen]], [[AI Video Production Tracker|AIV-074 People Partner — the offboarding]], [[AI Video Production Tracker|AIV-075 The exit screens]]"
tags:
  - scene
  - liam-arc
---
...
And every adjustment he ever made shows up on that sheet as a deficit. The 3% is him following a security policy he wrote and that is still in force. The authored-changes figure has gone *down* because he took Brendan's advice in [[12 - Below Expectations]] and started clearing his queue — advice he asked for, thanked him for, and acted on. **He adjusted, always, for real reasons, and every correction cost him.**

## Setting / Staging
A meeting room, and for once Liam is the only body on stage. **He is live, camera on, at a laptop** — the same exposure as [[13 - The Performance Review]], with nobody in the room to see it. On the screen, the **People Partner**, whose face the audience has never seen before and will not see again.

The room is the smallest and barest space in the play. No desk clutter, no second monitor until the end, nothing of his in it. **He brings nothing into it** — no document, no notes, no agenda. He is not preparing for anything, because nothing is happening.
...
>
> **The tone never fully goes.** It thins under the back half and is still there, very quiet, on the last image. Do not resolve it.

## Live Cast

- **LIAM** — live, Speaker A. **Cheerful at the top, and busy.** He has just found something and he is pleased about it and he has nowhere to put that. He is not braced. Then blank. **He must not shout and must not plead** — but this is not the composed man of the review. His sentences come apart, he asks for things to be repeated, and he opens a notes file, types the date, and never types another character. The only thing he does well all scene is congratulate somebody.

> [!note] Live/video plane
> One live actor against one screen. No contact, no shared props — the returns box exists on his side only. The People Partner never appears anywhere else in the play; the officers in Movement IV are this register escalated one notch.
...
- **[[AI Video Production Tracker|AIV-075]] — The exit screens (screen graphic, no voice):** the all-hands slide — Q3 promotions, Brendan's name on it, under the launch applause clip from [[10 - The Win We Needed]], **heard through the ring**; the HRIS record with "Eligible for rehire" flipping to **No**; a Slack notification in #general with forty-one reactions; and, for two seconds and no comment, the **pack email's attachment list** — the notice as to change in relationship, the state pamphlet, the health continuation forms, the separation agreement, and **"Appendix B — Decisional Unit Disclosure: job titles and ages, selected and not selected."** Nobody opens it. **The same thread and the same forty-one reactions are on Brendan's screen in [[14b - Three Weeks]]** — build the asset once.
...
*(He is four rows under the line. Two rows below him, BRENDAN — tickets closed, nine, because he moved the team's work to Linear a year ago and told everyone it was better, and was right. Eleven rows above the line, MARCUS, who files everything.)*
...
**LIAM** *(live, to nobody)*: Oh, you're *joking*.
...
**LIAM** *(live)*: *(beat)* Sorry. Can you go back.
...
- **Runtime.** 4.3 min spoken measured, **~4.7 with the pack and the disclosure added** (re-measure after re-rendering), plus the ring, which reads long on stage and measures as nothing. If it has to come down, the cuts in order are: the health-cover line, then "Is this about the Q4 staffing thing." **The disclosure exchange can go to a screen** — it plays on `AIV-075` either way — but the pack line itself has to stay, because [[14b - Three Weeks]] answers it. **Do not cut the prologue, the unfinished sentence at the top, the dongle, the notes file, or the last question.**
