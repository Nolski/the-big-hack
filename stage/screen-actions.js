...
export function renderScreenAction(c,side){
 ...
 if(a.view==='message')body=messageHead(a.title)+`<div class="policyReference"><small>${escape(a.context)}</small><blockquote>${escape(a.reference)}</blockquote><p>${escape(a.secondary)}</p></div><div class="messageComposer"><div class="composeTitle">Message Kristina</div><div class="messageInput">${input()}</div><div class="composeFooter"><span>Aa &nbsp; ☺ &nbsp; ＋</span><span class="sendButton">➤</span></div></div>`;
